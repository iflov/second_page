...
function addEventToCarousel(carouselElem){
    ...
    //너비값 조정
    var liWidth = liElems[0].clientWidth; //비상! 해당부분 에러 발생 > Uncaught TypeError: Cannot read properties of undefined (reading 'clientWidth') > 13번째 줄 querySelectorAll('li') 로 바꿔줘서 해결
    // querySelector 는 배열으로 리턴 되지 않는다! 배열이 필요할경우 querySelectorAll 로 해야한다.
